...
;// CONCATENATED MODULE: ./src/data/a.json
var a_namespaceObject = {"name":"123"};
// EXTERNAL MODULE: ./src/data/a.xml
var a = __webpack_require__(348);
var a_default = /*#__PURE__*/__webpack_require__.n(a);
// EXTERNAL MODULE: ./src/data/a.csv
var data_a = __webpack_require__(49);
var data_a_default = /*#__PURE__*/__webpack_require__.n(data_a);
...
;// CONCATENATED MODULE: ./src/react/Hello.js

function Hello() {
  return /*#__PURE__*/react.createElement("h1", null, "React Hello");
}
/* harmony default export */ var react_Hello = (Hello);
...
const root = client.createRoot(domContainer);
root.render( /*#__PURE__*/react.createElement(react_Hello, null));
let x = 100;
console.log(x, 'x');
console.log(lodash_default()(), 'lodash');
console.log(a_namespaceObject, 'json');
console.log((a_default()), 'xml');
console.log((data_a_default()), 'notes');
}();
/******/ })()
;
